...
class ReplayBuffer(object):
    ...
    def sample_random_data(self, batch_size):
        ...
        shuffled_indices = np.random.permutation(self.obs.shape[0])
        return self.obs[shuffled_indices][-batch_size:], \
               self.acs[shuffled_indices][-batch_size:], \
               self.rews[shuffled_indices][-batch_size:], \
               self.next_obs[shuffled_indices][-batch_size:], \
               self.terminals[shuffled_indices][-batch_size:]
